//       $Id: Utility.java 34838 2017-05-29 17:16:09Z p20068 $
//      $URL: https://svn01.fh-hagenberg.at/bin/cepheiden/vocational/teaching/Material/langs/Java/JDBC-template/src/swe4/util/Utility.java $
// $Revision: 34838 $
//     $Date: 2017-05-29 19:16:09 +0200 (Mo., 29 Mai 2017) $
...
// -----------------------------------------------
   ...
   public static String getRMIRegistryURL (String args [], String serviceName) {
      return getRMIRegistryURL (parseHost (args, "localhost"),   //
                                parsePort (args, 1099),          // default port for RMI registry: 1099
                                serviceName                      //
             );
   }
}
